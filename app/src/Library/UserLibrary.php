...
final class UserLibrary
{
    ...
    public function create($email, $password, $user_agent)
    {
        try {
            $sql = "INSERT INTO user (email, password, session) VALUES (:email, :password, :session)";
            ...
            $this->logger->info('MySQL\'s Error in UserLibrary (create): ' . $e);
            return false;
        }
    }
}
